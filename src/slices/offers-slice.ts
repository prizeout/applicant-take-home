...
export const selectActiveOffer = ({ offers: { activeOffer } }: RootState): PrizeoutOffer => activeOffer;

export const selectActiveOfferId = ({ offers: { activeOffer } }: RootState): null | string =>
    activeOffer?.giftcard_list?.[0].checkout_value_id;
